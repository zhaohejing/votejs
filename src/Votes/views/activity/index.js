    ...
    angular.module('MetronicApp')
        ...
        [
            ...
            function ($scope, $state, settings, dataFactory, $uibModal) {
                ...
                vm.mutileactors= function() {
                    var id = Object.getOwnPropertyNames(vm.table.checkModel);
                    if (id.length != 1) {
                        abp.notify.warn("请选择一个活动");
                        return;
                    }
                    var modal = $uibModal.open({
                        templateUrl: 'views/activity/modal.html',
                        controller: 'views.activity.modal as vm',
                        backdrop: 'static',
                       // size: 'lg',//模态框的大小尺寸
                        resolve: {
                            model: function () { return {  activityId: id[0] } }
                        }
                    });
